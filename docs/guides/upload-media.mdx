...
| platform   | image max | video max | mime allowed                        | carousel size |
|------------|-----------|-----------|-------------------------------------|---------------|
...
| Pinterest  | 20 MB     | —         | jpeg, png / —                       | single only   |
...
- **Bluesky enforces image-vs-video exclusivity.** A single post can have images *or* a video, not both. See [`bluesky.media.image_video_exclusive`](/preflight/bluesky-media-image_video_exclusive).
