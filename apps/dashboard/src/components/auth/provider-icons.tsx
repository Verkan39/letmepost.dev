/**
 * Brand icons for the auth providers. Inlined as SVGs (not a brand-icon
 * library) so:
 *   - GitHub stays single-color and inherits currentColor — looks right
 *     on both the primary button (black on green) and the outline button.
 *   - Google keeps its official four-color "G" — the recognizable shape
 *     is the entire point; recolored versions of it look off.
 */
