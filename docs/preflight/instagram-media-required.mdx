...
Add at least one image or video. If you want a text-first post, [Threads](/platforms/threads) is where it goes; the same content with `account.platform: "threads"` will publish text-only.
